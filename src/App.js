    ...
    <> {/*react fragment*/}
      <Navbar bg="dark" variant="dark">
        ...
        <Form inline>
          ...
          &nbsp;
          <Button variant="outline-primary" onClick={() => {obtemClima(cidade)}}><FaCloudversify color="yellow" size="20" /> Obter Clima</Button>
        </Form>
      </Navbar>
      <Jumbotron>
        <h1><FaCloudRain /> FateClima</h1>
        <p>
          Consulte o clima de qualquer cidade do mundo. <br/>
